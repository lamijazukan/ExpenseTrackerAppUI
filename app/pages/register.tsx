        ...
        <div className="relative z-10 flex flex-col items-center justify-end w-full pb-16 px-12">
          <div className="text-center max-w-sm">
            ...
            <p className="mt-3 text-sm text-white/80 leading-relaxed">
              Join thousands of users building better money habits with BudgetTrack.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="regName" className="text-foreground text-sm">Full Name</Label>
              <Input
                id="regName"
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="regEmail" className="text-foreground text-sm">Email</Label>
              <Input
                id="regEmail"
                type="email"
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="regPassword" className="text-foreground text-sm">Password</Label>
