...
import { mockCategories } from "@/app/lib/mock-data"
...
export function AddTransactionDialog() {
  ...
  const step2Valid = items.length > 0 && items.every((i) => i.category && i.amount && i.productName)
  ...
  return (
    ...
    >
      ...
      <DialogContent className="border-border bg-card text-card-foreground sm:max-w-lg">
        <DialogHeader>
          <DialogTitle className="text-card-foreground">Add Transaction</DialogTitle>
          <DialogDescription className="sr-only">
            Fill out the form to add a new transaction in three steps: details, items, and review.
          </DialogDescription>
        </DialogHeader>
        ...
        {step === 1 && (
          <div className="flex flex-col gap-4 pt-2">
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="paidDate" className="text-card-foreground text-sm">Paid Date</Label>
              <Input
                id="paidDate"
                type="date"
                value={paidDate}
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="store" className="text-card-foreground text-sm">Store</Label>
              <Input
                id="store"
            ...
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="totalAmount" className="text-card-foreground text-sm">Total Amount</Label>
              <Input
                id="totalAmount"
                type="number"
                placeholder="0.00"
